...
class AGANtestBModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.opt.saveMask:
            ...
            visual_names_B = ['real_B', 'fake_A', 'rec_B', 'fore_fb']
            self.visual_names = ['real_B', 'fake_A', 'rec_B', 'fore_fb']
    ...
    def set_input(self, input):
        ...
        self.real_B = input['B' if BtoA else 'A'].to(self.device)
    ...
    def forward(self):
        ...
        self.i1_a, self.i2_a, self.i3_a, self.i4_a, self.i5_a, self.i6_a, self.i7_a, self.i8_a, self.i9_a = self.netG_B(self.real_B, 'G_A')  # G_B(B)
